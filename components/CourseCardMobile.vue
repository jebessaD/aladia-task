<template>
    <div ref="courseCard" class="bg-white max-w-2xl md:max-w-3xl  mt-10 p-4 md:hidden">
        <div class="relative w-full">
            ...
            <nuxt-link to="/" class="text-gray-800 font-bold text-lg w-full flex "
        ...
        <div class="flex w-full border-b">
            ...
            <div class="px-4 py-2 flex-1 text-center cursor-pointer text-gray-500 font-bold"
                :class="{ ' border-b-black border-b-2 text-gray-950': activeTab === 'teams' }"
        ...
        <div class="p-8 pt-2">
            <div v-if="activeTab === 'personal'">
                ...
                <div class="my-4">
                    <p class="font-bold text-gray-800">$13.99 <span class="font-light line-through ml-1"> $74.99 </span>
                        <span class="font-normal ml-1"> 81% off</span>
                    </p>

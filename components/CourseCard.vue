<template>
  <div ref="courseCard" class="bg-white shadow-lg overflow-hidden p-4 border w-[21rem]" :class="{ 'fixed': isSticky }"
    :style="stickyStyle">
  ...
  setup() {
    ...
    const handleScroll = () => {
      ...
      if (scrollPosition > 150) {
        isSticky.value = true;
        stickyStyle.value = { top: '20px', right: '80px' }; 
      } else {
        isSticky.value = false;
        stickyStyle.value = { top: '100px', right: '80px' }; 
      }
    };
